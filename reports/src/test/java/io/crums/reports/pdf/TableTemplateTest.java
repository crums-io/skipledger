...
public class TableTemplateTest extends IoTestCase {
  ...
  public void simple() throws IOException {
    ...
    var tableTemplate = new TableTemplate(List.of(col, col));
...
//    var table = tableTemplate.createTableOld(List.of(inputs));
  ...
  private void writePdf(File file, TableTemplate table, String[] inputs) throws IOException {
  ...
  private TableTemplate loadFromResource(Object methodLabel) {

 ...
 */
public class LegacyTableTemplate {
  ...
  public static boolean equal(LegacyTableTemplate a, LegacyTableTemplate b) {
    return
        a == b ||
        a != null && b != null &&
   ...
   */
  public LegacyTableTemplate(List<CellFormat> columns) {
   ...
   * @param font    not null
   */
  public LegacyTableTemplate(int columns, FontSpec font) {
   ...
   */
  protected LegacyTableTemplate(LegacyTableTemplate copy) {

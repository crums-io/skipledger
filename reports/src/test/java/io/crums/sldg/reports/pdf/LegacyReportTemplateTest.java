 ...
 * 
 */
public class LegacyReportTemplateTest extends IoTestCase {
  ...
  public void testFromResource() throws IOException {
    ...
    var report =
        new LegacyReportTemplateParser(refedImages).toEntity(
  ...
  public static LegacyTableTemplate newTableTemplate(String resourceName) {
    var in = LegacyReportTemplateTest.class.getResourceAsStream(resourceName);
    assertNotNull(in, resourceName);
    return LegacyTableTemplateParser.INSTANCE.toEntity(in);
  }

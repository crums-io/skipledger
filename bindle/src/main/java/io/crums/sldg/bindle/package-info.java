 ...
 */
/**
 * Bindles are portable packages of proofs about entries from one or more ledgers.
 * 
 * <h2>Basic Organization</h2>
 * <p>
 * Entries (rows) from the same ledger are packaged in a structure
 * called a {@linkplain io.crums.sldg.bindle.Nugget}: a bindle will typically
 ...
 * {@linkplain io.crums.sldg.bindle.MultiPath MultiPath}). All other data
 ...
 * in another ledger (see {@linkplain io.crums.sldg.bindle.ForeignRefs}).
 * </li>

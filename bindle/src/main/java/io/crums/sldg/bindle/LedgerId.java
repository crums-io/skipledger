...
/**
 * Intra-bindle numeric ID for a ledger. Its main purpose is to provide a
 * <em>typed</em> number (the ID). The number is annotated with other
 ...
 * in a bindle, then it would take at most <em>k</em>-many look-ups (the row no.
...
public class LedgerId {
  ...
  /**
   * Returns the intra-bindle numeric ID. Unique across a bindle's ledgers.
   * This number may not survive in re-written versions of the bindle.
   * 
   * @return &ge; 0
   */
  public final int id() {
  ...
  /**
   * Returns the ledger's alias. Unique across a bindle.
   * 
  ...
  /**
   * Returns the ledger's URI. When present, it is unique across the bindle;

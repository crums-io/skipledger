...
import io.crums.sldg.bindle.LedgerInfo;
import io.crums.sldg.bindle.Bindle;
import io.crums.sldg.bindle.Bundle;
import io.crums.sldg.bindle.Nugget;
import io.crums.util.Lists;

/**
 * Edits the {@linkplain LedgerId}s of an exisiting {@linkplain Bindle}.
 * <p>
 * This class does not implement {@linkplain Bundle} because it does not guarantee
 ...
 */
public class BindleIdEditor implements Bindle {
  ...
  /**
   * Constructs an instance over the given {@code base} bindle.
   */
  public BindleIdEditor(Bindle base) {
    this.base = base;
    if (base.ids().isEmpty())

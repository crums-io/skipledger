...
/**
 * Classification of ledgers recognized by the bindle format.
 */
public enum LedgerType {
  ...
  private final static LedgerType[] TYPES = LedgerType.values();
  
  
  
  public static LedgerType forOrdinal(int ordinal)
   ...
   * as an <em>annotation in another ledger nugget</em>.
   */
  ...
  /**
   * Returns {@code this == } {@linkplain #TIMECHAIN}.
   */
  public boolean isTimechain() {
    return this == TIMECHAIN;
  }


  /**
   * Returns {@code this == } {@linkplain #LOG}.
   */
  ...
  /**
   * Returns {@code this == } {@linkplain #TABLE}.
   */
  ...
  /**
   * Returns {@code this == } {@linkplain #BSTREAM}.
   */

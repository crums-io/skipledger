...
public interface Bindle {
   ...
   *         if this bindle contains no such ledger by that {@code alias}
   * 
   * @see #findIdByAlias(String)
   * @see LedgerId#alias()
   */
  ...
  /**
   * Returns the ledger nugget with the given {@code id}.
   * 
   * @param id  one of the {@linkplain #ids()}
   * 
   * @throws IllegalArgumentException
   *         if {@code id} does not belong to this bindle (not one {@linkplain #ids()})
   */

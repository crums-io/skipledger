 ...
 * </p><p>
 * Morsels package crumtrails in decomposed form. A crumtrail's first part,
 * its "cargo hash proof", is packaged alongside the ledger (that is,
 * inside the morsel's ledger-specific container). The crumtrail's second part,
 * its block proof (the skip ledger path), is treated as any other ledger.
 * </p>
 */
package io.crums.sldg.morsel.tc;
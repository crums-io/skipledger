...
/**
 * Morsels with a common serial format.
 * 
 * @see Morsel
 */
public interface Mug extends Morsel, Serial {
  
  /**
   * Returns the given {@code morsel} as a {@code Mug}.
   * 
   * @return  {@code morsel}, if it implements this interface;
   *          a view, otherwise
   */
  public static Mug asMug(Morsel morsel) {
    if (morsel instanceof Mug mug)
      return mug;

...
/**
 * Lazy-loading, unverified, {@linkplain Morsel}.
 * There are 2 concrete implementations. These are, in order of laziness:
 * <ol>
 * <li>In-memory: {@linkplain LazyMug}, marshalled from raw bytes</li>
 * <li>File-based: {@linkplain MorselFile}. Much like the in-memory version,
 ...
 * @see ObjectMug
 */
public abstract class LazyMorsel extends MugBase {
  ...
  LazyMorsel(LedgerId[] ids, Partition nuggets) {
    super(ids);
    verifyIds();

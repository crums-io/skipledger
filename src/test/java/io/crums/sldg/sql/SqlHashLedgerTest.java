...
import io.crums.sldg.MorselPackTest;
 ...
 * 
 */
public class SqlHashLedgerTest extends IoTestCase {
  ...
  public void testEmpty() throws Exception {
    ...
    try (SqlHashLedger hLedger = declareNewInstance(label)) {
  ...
  SqlHashLedger declareNewInstance(Object methodLabel) throws Exception {
    File dir = getMethodOutputFilepath(methodLabel);
    return declareNewInstance(dir);
  }
  
  
  SqlHashLedger declareNewInstance(File testDir) throws Exception {
